// Sidebar: runbooks plus the session's runs, kept fresh by polling the
// cheap /api/runs summary whenever a run is live.
...
import { BookOpen, FlaskConical } from "lucide-solid";
import { listRunbooks, listRuns } from "../api";
